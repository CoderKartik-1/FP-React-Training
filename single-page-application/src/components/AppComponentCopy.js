...
export default function AppComponentCopy() {
    return (
        <BrowserRouter>
            <>
...
function HomeComponent(props) {
    ...
    function redirectToAbout() {
        console.log(props);
        props.history.push("/about?userId=10&userName=20");
    }
    return (
        <>
            <h1>This is Home Page</h1>
            <input type="button" value="Redirect to About With Query Params" onClick={redirectToAbout} />
        </>
    )
}
